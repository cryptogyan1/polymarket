...
class PositionGuard:
    ...
    def cashout_market(
        ...
        for attempt in range(attempts):
            ...
            # 99.9% first attempt, progressively down to 99.6% on later attempts.
            # This avoids leaving meaningful dust on small positions.
            safety_factor = max(0.996, 0.999 - (0.001 * attempt))
